...
class TestSupportCenterService(TestCase):
    ...
    def test_that_intervals_stays_within_limits(self):
        from_ = datetime.fromisoformat('2020-10-10T00:00:00').astimezone(MTL_TZ)
        until = datetime.fromisoformat('2020-10-12T12:00:00').astimezone(MTL_TZ)
        intervals = list(
    ...
    def test_that_daily_interval_changes_dst_up(self):
        from_ = datetime.fromisoformat('2020-10-31T00:00:00').astimezone(MTL_TZ)
        until = datetime.fromisoformat('2020-11-02T00:00:00').astimezone(MTL_TZ)
        intervals = list(
            self.service._generate_subinterval(
                from_, until, relativedelta(days=1), MTL_TZ
            )
    ...
    def test_that_monthly_interval_changes_dst_up(self):
        from_ = datetime.fromisoformat('2020-10-01T00:00:00').astimezone(MTL_TZ)
        until = datetime.fromisoformat('2020-12-01T00:00:00').astimezone(MTL_TZ)
        intervals = list(
            self.service._generate_subinterval(
    ...
    def test_that_hourly_interval_changes_dst_down(self):
        from_ = datetime.fromisoformat('2020-03-07T23:00:00').astimezone(MTL_TZ)
        until = datetime.fromisoformat('2020-03-08T04:00:00').astimezone(MTL_TZ)
        intervals = list(
            self.service._generate_subinterval(
                from_, until, relativedelta(hours=1), MTL_TZ
            )
    ...
    def test_that_daily_interval_changes_dst_down(self):
        from_ = datetime.fromisoformat('2020-03-07T00:00:00').astimezone(MTL_TZ)
        until = datetime.fromisoformat('2020-03-09T00:00:00').astimezone(MTL_TZ)
        print("Patate")
        intervals = list(
            self.service._generate_subinterval(
                from_, until, relativedelta(days=1), MTL_TZ
    ...
    def test_that_monthly_interval_changes_dst_down(self):
        from_ = datetime.fromisoformat('2020-03-01T00:00:00').astimezone(MTL_TZ)
        until = datetime.fromisoformat('2020-05-01T00:00:00').astimezone(MTL_TZ)
        intervals = list(
            self.service._generate_subinterval(
                from_, until, relativedelta(months=1), MTL_TZ
            )
