...
class TestCallLogGenerationScenarios(TestCase):
    ...
    @raw_cels(
        ...
        WAZO_CALL_LOG_DESTINATION | 1715113655.622 | 1715113655.622 | 2024-05-07 20:27:35.477246+00 | 0012345678910 | 0012345678910                        | s                                    | group                         | PJSIP/2c70p24m-000000a3                                               | CELGenUserEvent | WAZO_CALL_LOG_DESTINATION,type: group,id: 9,name: grp-charlescli-9f16208e-bf72-4d71-be21-48a10377dc15                                                   | {"extra":"type: group,id: 9,name: grp-charlescli-9f16208e-bf72-4d71-be21-48a10377dc15"}
    ...
    def test_incoming_call_to_group_ring_all_no_answer(self, cels):
        ...
        expected_properties = dict(
            ...
            destination_name='grp-charlescli-9f16208e-bf72-4d71-be21-48a10377dc15',
            direction='inbound',
        )
    ...
    @raw_cels(
        ...
        WAZO_CALL_LOG_DESTINATION | 1715115875.647 | 1715115875.647 | 2024-05-07 21:04:35.923002+00 | 0012345678910 | 0012345678910                        | s                                    | group                         | PJSIP/2c70p24m-000000aa                                               | CELGenUserEvent | WAZO_CALL_LOG_DESTINATION,type: group,id: 7,name: supportgroup1                                                                                         | {"extra":"type: group,id: 7,name: supportgroup1"}
