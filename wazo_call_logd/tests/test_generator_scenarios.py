...
class TestCallLogGenerationScenarios(TestCase):
    ...
    @raw_cels(
        ...
        WAZO_CALL_LOG_DESTINATION      | 2022-07-21 09:31:28.73542         | Harry Potter          | 1603          | 1603      | s         | user          | PJSIP/cul113qn-00000000   | 1658410288.0  | 1658410288.0      | {"extra":"type: user,uuid: cb79f29b-f69a-4b93-85c2-49dcce119a9f,name: Harry Potter,tenant_uuid: 006a72c4-eb68-481a-808f-33b28ec109c8"}
    ...
    @raw_cels(
        ...
        WAZO_CALL_LOG_DESTINATION | 1715113655.622 | 1715113655.622 | 2024-05-07 20:27:35.477246+00 | 0012345678910 | 0012345678910                        | s                                    | group                         | PJSIP/2c70p24m-000000a3                                               | CELGenUserEvent | WAZO_CALL_LOG_DESTINATION,type: group,id: 9,label: supportgroup1,tenant_uuid: 54eb71f8-1f4b-4ae4-8730-638062fbe521                                                                                        | {"extra":"type: group,id: 9,label: supportgroup1,tenant_uuid: 54eb71f8-1f4b-4ae4-8730-638062fbe521"}
    ...
    @raw_cels(
        ...
        WAZO_CALL_LOG_DESTINATION | 1715115875.647 | 1715115875.647 | 2024-05-07 21:04:35.923002+00 | 0012345678910 | 0012345678910                        | s                                    | group                         | PJSIP/2c70p24m-000000aa                                               | CELGenUserEvent | WAZO_CALL_LOG_DESTINATION,type: group,id: 7,label: supportgroup1,tenant_uuid: 54eb71f8-1f4b-4ae4-8730-638062fbe521                                                                                        | {"extra":"type: group,id: 7,label: supportgroup1,tenant_uuid: 54eb71f8-1f4b-4ae4-8730-638062fbe521"}
    ...
    @raw_cels(
        ...
        WAZO_CALL_LOG_DESTINATION      | 2022-07-21 09:31:37.73542         | Harry Potter          | 1603          | 1603      | s         | user          | PJSIP/cul113qn-00000002   | 1658410289.0  | 1658410289.0      | {"extra":"type: user,uuid: cb79f29b-f69a-4b93-85c2-49dcce119a9f,name: Harry Potter,tenant_uuid: 006a72c4-eb68-481a-808f-33b28ec109c8"}
