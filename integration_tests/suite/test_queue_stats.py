...
class TestStatistics(IntegrationTest):
    ...
    # fmt: on
    def test_qos_period_thresholds_by_hour_all_params_and_dst_change(self):
        results = self.call_logd.queue_statistics.get_qos_by_id(
            queue_id=1,
    ...
    # fmt: on
    def test_qos_period_thresholds_by_day_all_params(self):
        results = self.call_logd.queue_statistics.get_qos_by_id(
            queue_id=1,
            from_='2020-10-30T00:00:00-04:00',
            until='2020-11-03T00:00:00-05:00',
    ...
    @stat_call_on_queue({'queue_id': 1, 'time': '2020-11-02T011:12:00-04:00', 'waittime': 10, 'status': 'answered'})
    # fmt: on
    def test_qos_period_thresholds_by_month_all_params(self):
        results = self.call_logd.queue_statistics.get_qos_by_id(
            queue_id=1,
