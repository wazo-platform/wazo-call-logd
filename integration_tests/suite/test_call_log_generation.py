...
--------------------------------+-----------------------------------+-------------------+-----------+-----------+-----------+------------+--------------------------+----------------+----------------+-----------------------------------------------------------------------------------------
 ...
 WAZO_CALL_LOG_DESTINATION      | 2022-07-20 17:56:12.285233        | Harry Potter      | 1603      | 1603      | s         | user       | PJSIP/cul113qn-0000000c  | 1658354172.12  | 1658354172.12  | {"extra":"type: user,id: c3f297bd-93e1-46f6-a309-79b320acb7fb,name: Willy Wonka"}
...
--------------------------------+-----------------------------------+-----------------------+---------------+-----------+-----------+---------------+---------------------------+---------------+-------------------+-------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 WAZO_CALL_LOG_DESTINATION      | 2022-07-21 09:31:28.73542         | Harry Potter          | 1603          | 1603      | s         | user          | PJSIP/cul113qn-00000000   | 1658410288.0  | 1658410288.0      | {"extra":"type: user,id: cb79f29b-f69a-4b93-85c2-49dcce119a9f,name: Harry Potter"}
...
--------------------------------+-----------------------------------+-----------------------+---------------+-----------+---------------+---------------+---------------------------+---------------+-------------------+--------------------------------------------------------------------------------------------------
 ...
 WAZO_CALL_LOG_DESTINATION      | 2022-07-22 18:56:20.276577        | Harry Potter          | 1603          | 1603      | participant   | wazo-meeting  | PJSIP/cul113qn-00000001   | 1658530580.3  | 1658530580.3      | {"extra":"type: meeting,id: 9195757f-c381-4f38-b684-98fef848f48b,name: Meeting with Harry Potter"}
