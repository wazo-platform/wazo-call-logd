...
class TestListCDR(IntegrationTest):
    ...
    @call_logs(
        [
            ...
            {'date': '2017-04-12'},
            {
                'date': '2017-04-13',
                'participants': [
                    {'user_uuid': USER_1_UUID, 'tags': ['quebec', 'montreal']}
                ],
            },
            {
                'date': '2017-04-14',
    ...
    @call_logs(
        [
            {'date': '2018-06-06', 'participants': [{'user_uuid': USER_1_UUID}]}
            for _ in range(1100)
        ]
    )
    ...
    @call_logs(
        [
            ...
            {'id': 13, 'date': '2017-03-23 00:00:00', 'tenant_uuid': MASTER_TENANT},
        ]
    )
